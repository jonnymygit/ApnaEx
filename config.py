...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "21805580"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","b008874785e462ece4a6a2fbb2023824")
# ------------------------------------------------
...
# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1003427507980")) 
# ------------------------------------------------
